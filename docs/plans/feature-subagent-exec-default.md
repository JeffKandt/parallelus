# Branch Plan — feature/subagent-exec-default

## Objectives
- merge exec-mode subagent runner + monitoring improvements into `main`
- document the exec-default behavior and the opt-in TUI override (`PARALLELUS_CODEX_USE_TUI=1`)
...
## Next Actions
- finalize merge prerequisites (retro + review + fold)
