...
- Clarified the senior architect manual with explicit tmux cleanup/read-only reminders and restored the reviewer prompt's "Subagent Operating Context" guidance to keep guardrails intact.
