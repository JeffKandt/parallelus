...
SCOPE_TEMPLATE=${SCOPE_TEMPLATE:-"$ROOT/parallelus/engine/prompts/process_smoke.txt"}
...
The harness will:
  1. Launch a throwaway sandbox via parallelus/engine/bin/subagent_manager.sh launch
