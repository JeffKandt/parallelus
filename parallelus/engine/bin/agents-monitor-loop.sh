...
TMUX_HELPER="$REPO_ROOT/parallelus/engine/bin/tmux-safe"
...
SEND_KEYS_CMD="$REPO_ROOT/parallelus/engine/bin/subagent_send_keys.sh"
TAIL_CMD="$REPO_ROOT/parallelus/engine/bin/subagent_tail.sh"
...
REGISTRY="parallelus/manuals/subagent-registry.json"
MANAGER_CMD="$(git rev-parse --show-toplevel)/parallelus/engine/bin/subagent_manager.sh"
