...
1. Copy the `parallelus/engine/` directory and `parallelus/manuals/` manuals.
...
3. Preserve the core guardrails; if you need project-specific behaviour, add sidecar scripts/manuals under `parallelus/engine/custom/` or `parallelus/manuals/manuals/` rather than editing Parallelus core files.
